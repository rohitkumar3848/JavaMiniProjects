...
public class NumberGuessingGame implements ActionListener, KeyListener {
...
//Managing look and feel of JOptionPane
        UI.put("OptionPane.background",new Color(255,150,134));
        UI.put("Panel.background",new Color(255,150,134));
...
//Setting Properties of JPanel one and two
        ...
        panel2.setBackground(new Color(250,191,92));
...
//Setting properties of the components
        ...
        textLabel4.setText("( Between 0 to 100 )");
...
//Creating object of the class
        NumberGuessingGame guessingGameJava=new NumberGuessingGame();
